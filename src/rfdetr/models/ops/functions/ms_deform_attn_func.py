...
def ms_deform_attn_core_pytorch(
    ...
    # sampling_locations is rank 6 (batch, len_q, n_heads, n_levels, n_points, 2) on the eager
    # path, or rank 5 (batch, len_q, n_heads, n_levels*n_points, 2) on the export path, which
    # merges (n_levels, n_points) to keep every tensor <= rank 5 for CoreML. Both carry identical
    # values; handle each by indexing the level slice.
